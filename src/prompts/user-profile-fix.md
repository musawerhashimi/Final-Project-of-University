...
hey bro this is good but need some fixes
first: improve the light coloring the dark is good but the light need some fixes
second
in change password please add it like this old password, new password, confirm password
in theme show light, dark, and system

and important one coloring

you used bg-dfgsdfgdfg and dark:bg-asdfasdf
and other colors like this
instead if you wanna give an element different colors in different modes
first define a color name for it as --color-sdfsdf: #eee;
and give it different color values in different modes
like.
.light {
  --color-dfgdsf: #eee;
}
...
and use it like this bg-dfgdsf or text-dfgdsf

also improve the styling or other parts as need be and you think is necessary.
if you have any question ask